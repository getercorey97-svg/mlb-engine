...
def fetch_gdelt_tone(team_name):
    ...
    params = {"query": f'"{team_name}" (scandal OR controversy OR injury)', "mode": "artlist", "maxrecords": "5", "format": "json"}
    try:
...
def execute_discovery_ingestion():
    ...
    print(f"Executing Cached Media Discovery for {len(games)} Live Games...")
