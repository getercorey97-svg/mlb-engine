...
from factual_post_mortem import update_dynamic_weights 
    ...
    while current_date <= end_date:
        ...
        for date_data in day_res.get('dates', []):
            for game in date_data.get('games', []):
                ...
                games_data.append({'game_pk': game_pk, 'home': home_team, 'away': away_team, 'h_score': home_score, 'a_score': away_score, 'h_f5': h_f5, 'a_f5': a_f5})
                day_games_count += 1
        ...
        for g in games_data:
            ...
            cursor.execute("SELECT f5_home_prob FROM F5_Forecasts WHERE game_pk = ?", (g['game_pk'],))
            ...
            if f5_forecast: f5_brier_sum += (f5_forecast[0] - actual_f5_home_win) ** 2
